    ...
    async def execute(
        ...
        **kwargs,
        ...
        if not dockerfile_path:
            return ErrorResult(
                message="Dockerfile path is required", code="VALIDATION_ERROR"
            )
