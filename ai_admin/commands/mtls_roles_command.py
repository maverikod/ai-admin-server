...
from ai_admin.core.custom_exceptions import ConfigurationError, CustomError, PermissionError, SSLError
        ...
        **kwargs,
        ...
        try:
            if not role_name or not operation:
                raise PermissionError("Role name and operation are required for access check")
            ...
            raise PermissionError(f"Access check failed: {str(e)}")
        ...
        **kwargs,
        ...
        try:
            if not role_name or not permissions:
                raise PermissionError("Role name and permissions are required")
