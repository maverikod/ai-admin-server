...
from ai_admin.core.custom_exceptions import CustomError, PermissionError
    ...
    async def _get_cluster_info(
        ...
        try:
            ...
            nodes_result = subprocess.run(
                nodes_cmd, capture_output=True, text=True, timeout=30
            )
    ...
    async def _switch_cluster(
        ...
        try:
            ...
            if not test_result.get("success", False):
                raise PermissionError(f"Cluster '{cluster_name}' is not accessible")
