"""Core server entry point for ai_admin."""
...
"""Server configuration and setup for AI Admin application.

This module provides server configuration and setup functionality
for the AI Admin FastAPI application with mTLS support.
...
from .factory_exceptions import AppCreationError
...
async def run_ai_admin_server(
    ...
    """
    Run AI Admin server with specified configuration.
...
if __name__ == "__main__":
    """Run AI Admin server when script is executed directly."""
    import argparse

    parser = argparse.ArgumentParser(description="AI Admin Server")
    ...
    parser.add_argument("--disable-ssl", action="store_true", help="Disable SSL")
    parser.add_argument("--disable-mtls", action="store_true", help="Disable mTLS")
