"""Command registry and custom commands hook for AI Admin.

This module provides initialize_commands and custom_commands_hook for registering
AI Admin commands with the MCP proxy.
...
"""Command registry for AI Admin server.

This module provides functions for registering AI Admin custom commands
and managing command initialization.
...
def custom_commands_hook(registry):
    ...
    try:
        ...
        from ai_admin.commands.ftp_mkdir_command import FtpMkdirCommand
        from ai_admin.commands.ftp_rename_command import FtpRenameCommand
        from ai_admin.commands.ftp_info_command import FtpInfoCommand
        from ai_admin.commands.ftp_test_command import FtpTestCommand
        ...
        from ai_admin.commands.ollama_test_command import OllamaTestCommand
        from ai_admin.commands.ollama_generate_command import OllamaGenerateCommand
        from ai_admin.commands.ollama_chat_command import OllamaChatCommand
        from ai_admin.commands.ollama_embeddings_command import OllamaEmbeddingsCommand
        from ai_admin.commands.ollama_create_command import OllamaCreateCommand
        ...
        from ai_admin.commands.queue_statistics_command import QueueStatisticsCommand
        from ai_admin.commands.queue_health_command import QueueHealthCommand
        from ai_admin.commands.queue_clear_command import QueueClearCommand
        from ai_admin.commands.queue_logs_command import QueueLogsCommand
        from ai_admin.commands.queue_filter_command import QueueFilterCommand
        from ai_admin.commands.queue_cancel_task_command import QueueCancelTaskCommand
        from ai_admin.commands.queue_remove_task_command import QueueRemoveTaskCommand
        ...
        from ai_admin.commands.get_methods_command import GetMethodsCommand
        ...
        commands_to_register = [
            ...
            OllamaChatCommand,
            OllamaEmbeddingsCommand,
            OllamaCreateCommand,
            TestDiscoveryCommand,
            QueueManageCommand,
            QueueSSLCommand,
            QueueStatisticsCommand,
            QueueHealthCommand,
            QueueClearCommand,
            QueueLogsCommand,
            QueueFilterCommand,
            QueueCancelTaskCommand,
            QueueRemoveTaskCommand,
            ConfigCommand,
            K8sPodCreateCommand,
            K8sPodDeleteCommand,
