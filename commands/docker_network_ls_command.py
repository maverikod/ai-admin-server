...
class DockerNetworkLsCommand(BaseUnifiedCommand):
        ...
        **kwargs,
        ...
        try:
            ...
            if result.returncode != 0:
                raise InternalError(f"Failed to list Docker networks: {result.stderr}")
            ...
            raise InternalError(f"Docker network ls command timed out: {str(e)}")
        except InternalError as e:
            raise InternalError(f"Docker network ls failed: {str(e)}")
