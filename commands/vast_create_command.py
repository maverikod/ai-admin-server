        ...
        try:
            ...
            if use_queue:
                ...
                await queue_manager.add_job(
                    ...
                    job_id,
                    {
                        ...
                        "auto_import_modules": ["commands.vast_create_command"],
                    },
                )
                ...
                return SuccessResult(
                    data={
                        "status": "queued",
                        "message": ("Vast.ai instance creation task added to queue " "with SSL/mTLS security"),
                        "job_id": job_id,
                        "bundle_id": bundle_id,
                        "image": image,
                        "disk": disk,
            ...
            if "new_contract" in response_data:
                ...
                return SuccessResult(
                    data={
                        "status": "success",
                        "message": ("Successfully created instance with contract ID: " "{contract_id}"),
