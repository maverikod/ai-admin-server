    ...
    async def _list_models(
        ...
        **kwargs,
        ...
        try:
            ...
            raise InternalError(f"Network error during models list: {str(e)}")
    ...
    async def _pull_model(
        ...
        **kwargs,
        ...
        try:
            ...
            raise InternalError(f"Network error during model pull: {str(e)}")
        except CustomError as e:
    ...
    async def _remove_model(
        ...
        **kwargs,
        ...
        try:
            ...
            raise InternalError(f"Network error during model remove: {str(e)}")
        except CustomError as e:
    ...
    async def _show_model(
        ...
        **kwargs,
        ...
        try:
            ...
            raise InternalError(f"Network error during model show: {str(e)}")
        except CustomError as e:
