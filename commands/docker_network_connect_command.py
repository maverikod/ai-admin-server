        ...
        **kwargs,
        ...
        try:
            ...
            if result.returncode != 0:
                raise InternalError(f"Failed to connect container to network: {result.stderr}")
            ...
            raise InternalError(f"Docker network connect command timed out: {str(e)}")
        except InternalError as e:
            raise InternalError(f"Docker network connect failed: {str(e)}")
