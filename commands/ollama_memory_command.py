    ...
    async def _show_memory(
        ...
        **kwargs,
        ...
        try:
            ...
            raise InternalError(f"Network error during memory show: {str(e)}")
    ...
    async def _clear_memory(
        ...
        **kwargs,
        ...
        try:
            ...
            raise InternalError(f"Network error during memory clear: {str(e)}")
        except CustomError as e:
    ...
    async def _get_memory_stats(
        ...
        **kwargs,
        ...
        try:
            ...
            raise InternalError(f"Network error during memory stats: {str(e)}")
        except CustomError as e:
