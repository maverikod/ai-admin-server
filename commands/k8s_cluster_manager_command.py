...
class K8sClusterManagerCommand(BaseUnifiedCommand):
        ...
        **kwargs,
        ...
        try:
            if cluster_type == "minikube":
                ...
                raise CustomError(f"Start not supported for cluster type: {cluster_type}")
        ...
        **kwargs,
        ...
        try:
            if cluster_type == "minikube":
                ...
                raise CustomError(f"Stop not supported for cluster type: {cluster_type}")
        ...
        **kwargs,
        ...
        try:
            if cluster_type == "kind":
                ...
                raise CustomError(f"Status not supported for cluster type: {cluster_type}")
