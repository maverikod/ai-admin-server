...
"""Security Metrics for AI Admin.

This module provides unified security metrics collection and analysis
for all components, ensuring consistent security monitoring across the system.
