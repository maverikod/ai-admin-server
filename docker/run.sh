...
# Default values
IMAGE_NAME="ai-admin-server:latest"
...
DOCKER_CMD="$DOCKER_CMD -v ~/.kube:/home/appuser/.kube:ro"
DOCKER_CMD="$DOCKER_CMD -v \$(pwd)/../models:/app/models"
DOCKER_CMD="$DOCKER_CMD -v ~/.ollama:/home/appuser/.ollama"
DOCKER_CMD="$DOCKER_CMD -p 11434:11434"
DOCKER_CMD="$DOCKER_CMD --network smart-assistant"
